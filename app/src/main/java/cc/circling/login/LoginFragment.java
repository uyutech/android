...
import cc.circling.LoginActivity;
import cc.circling.utils.LogUtil;
import cc.circling.web.MyCookies;
import cc.circling.web.URLs;
import cc.circling.widget.ErrorTip;
...
public class LoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(cc.circling.R.layout.fragment_login, container, false);
        loginActivity = (LoginActivity) getActivity();
        errorTip = loginActivity.getErrorTip();
        handler = new Handler();

        userName = (EditText) view.findViewById(cc.circling.R.id.userName);
        userPass = (EditText) view.findViewById(cc.circling.R.id.userPass);
        switchShowPass = (ImageView) view.findViewById(cc.circling.R.id.switchShowPass);
        forgetPass = (TextView) view.findViewById(cc.circling.R.id.forgetPass);
        login = (Button) view.findViewById(cc.circling.R.id.login);
        ...
        switchShowPass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (showPass) {
                    ...
                    switchShowPass.setImageResource(cc.circling.R.drawable.pass_invisible);
                }
                else {
                    userPass.setInputType(InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD);
                    switchShowPass.setImageResource(cc.circling.R.drawable.pass_visible);
                }
